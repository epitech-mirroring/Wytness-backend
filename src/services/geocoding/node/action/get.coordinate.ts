...
@Injectable()
export class GetCoordinate extends Action {
  @Inject()
  ...
  constructor() {
    super(
      'Get coordinate of an location',
      'Get coordinate information for an address ex: Epitech Nantes',
      ['output'],
      [
        new Field(
          'Location',
          'location',
          'The address to Geocode ex: Epitech Nantes',
          FieldType.STRING,
          false,
        ),
      ],
  ...
  async execute(
    ...
    return {
      coordinate: {
        lat: resJson.features[0].properties.lat,
        lon: resJson.features[0].properties.lon,
      },
    };
  }
